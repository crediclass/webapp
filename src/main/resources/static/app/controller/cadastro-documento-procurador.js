app.controller("cadastroDocumentoProcuradorController", function ($scope, $http, messageService, oportunidadeService) {

    $scope.documento = {};
    $scope.documentos = [];
    $scope.agrupamentoDocumentos = [];
    var baseUrl = 'api/modulo-gi/doc-procurador';

    $scope.findAll = function () {
        $scope.documentos = [];
        oportunidadeService.get('api/modulo-gi/doc-procurador/todos').then(function (response) {
    ...
    $scope.save = function () {
        ...
        $http({
            method: 'POST',
            url: 'api/modulo-gi/doc-procurador',
