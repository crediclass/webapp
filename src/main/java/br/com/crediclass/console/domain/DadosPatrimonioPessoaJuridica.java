...
@NoArgsConstructor
@Entity
@Table(name = "console_dados_patrimonio_pj")
public class DadosPatrimonioPessoaJuridica implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final DadosPatrimonioPessoaJuridica other = (DadosPatrimonioPessoaJuridica) obj;
