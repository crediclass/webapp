...
import br.com.crediclass.console.service.DocumentosProponenteDadosService;
 ...
 */
@RestController
@RequestMapping("api/modulo-gi/doc-proponente-dados")
public class DocumentosProponenteDadosController {

    @Autowired
    private DocumentosProponenteDadosService service;
    ...
    public ResponseEntity<DocumentosProponenteDados> findById(@PathVariable Long userId) {
...
//    }
    ...
    @PostMapping
    public ResponseEntity<DocumentosProponenteDados> save(@RequestBody DocumentosProponenteDados value) {
        return new ResponseEntity<>(service.save(value), HttpStatus.OK);
    }

    @PutMapping
    public ResponseEntity<DocumentosProponenteDados> update(@RequestBody DocumentosProponenteDados value) {
        return new ResponseEntity<>(service.save(value), HttpStatus.OK);
    }

    @DeleteMapping
    public ResponseEntity<?> delete(@RequestBody DocumentosProponenteDados value) {
