...
import br.com.crediclass.console.service.TipoPatrimonioService;
 ...
 */
@RestController
@RequestMapping("api/modulo-gi/tipo-patrimonio")
public class TipoPatrimonioController {
    ...
    @PostMapping
    public ResponseEntity<?> save(@RequestBody TipoPatrimonio value) {
        return new ResponseEntity<>(service.save(value), HttpStatus.OK);
    }

    @PutMapping
    public ResponseEntity<?> update(@RequestBody TipoPatrimonio value) {
        return new ResponseEntity<>(service.save(value), HttpStatus.OK);
    }

    @DeleteMapping
    public ResponseEntity<?> delete(@RequestBody TipoPatrimonio value) {
