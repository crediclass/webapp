...
import br.com.crediclass.console.service.DocumentosProcuradorDadosService;
 ...
 */
@RestController
@RequestMapping("api/modulo-gi/doc-procurador-dados")
public class DocumentosProcuradorDadosController {

    @Autowired
    private DocumentosProcuradorDadosService service;
    ...
    public ResponseEntity<DocumentosProcuradorDados> findById(@PathVariable Long userId) {
...
//    }
    ...
    @PostMapping
    public ResponseEntity<DocumentosProcuradorDados> save(@RequestBody DocumentosProcuradorDados value) {
        return new ResponseEntity<>(service.save(value), HttpStatus.OK);
    }

    @PutMapping
    public ResponseEntity<DocumentosProcuradorDados> update(@RequestBody DocumentosProcuradorDados value) {
        return new ResponseEntity<>(service.save(value), HttpStatus.OK);
    }

    @DeleteMapping
    public ResponseEntity<?> delete(@RequestBody DocumentosProcuradorDados value) {
