...
import br.com.crediclass.console.service.EstadoCivilService;
 ...
 */
@RestController
@RequestMapping("api/modulo-gi/estado-civil")
public class EstadoCivilController {
    ...
    @PostMapping
    public ResponseEntity<?> save(@RequestBody EstadoCivil value) {
        return new ResponseEntity<>(service.save(value), HttpStatus.OK);
    }

    @PutMapping
    public ResponseEntity<?> update(@RequestBody EstadoCivil value) {
        return new ResponseEntity<>(service.save(value), HttpStatus.OK);
    }

    @DeleteMapping
    public ResponseEntity<?> delete(@RequestBody EstadoCivil value) {
