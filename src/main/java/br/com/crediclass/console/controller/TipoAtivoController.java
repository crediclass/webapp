...
import br.com.crediclass.console.service.TipoAtivoService;
 ...
 */
@RestController
@RequestMapping("api/modulo-gi/tipo-ativo")
public class TipoAtivoController {
    ...
    @PostMapping
    public ResponseEntity<?> save(@RequestBody TipoAtivo value) {
        return new ResponseEntity<>(service.save(value), HttpStatus.OK);
    }

    @PutMapping
    public ResponseEntity<?> update(@RequestBody TipoAtivo value) {
        return new ResponseEntity<>(service.save(value), HttpStatus.OK);
    }

    @DeleteMapping
    public ResponseEntity<?> delete(@RequestBody TipoAtivo value) {
